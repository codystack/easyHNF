                    ...
                    <main class="container-fluid" style="padding: unset">
                        ...
                        <div class="container px-16">
                            <div class="row align-items-center">
                                ...
                                <div class="col-sm-4 col-12" style="display: <?php if (!$short_description) {
                                                                                    echo 'none';
                                                                                } else {
                                                                                    echo 'unset';
                                                                                }; ?>">
                                ...
                                <div class="col" style="display: <?php if (!$short_description) {
                                                                        echo 'none';
                                                                    } else {
                                                                        echo 'unset';
                                                                    }; ?>">
                                ...
                                <div class="mb-20 mt-5" style="display: <?php if (!$short_description) {
                                                                            echo 'none';
                                                                        } else {
                                                                            echo 'unset';
                                                                        }; ?>">
                                ...
                                <div class="col-sm-4 col-12" style="display: <?php if (!$long_description) {
                                                                                    echo 'none';
                                                                                } else {
                                                                                    echo 'unset';
                                                                                }; ?>">
                                ...
                                <div class="col">
                                    <div class="hstack justify-content-end" style="display: <?php if (!$long_description) {
                                                                                                echo 'none';
                                                                                            } else {
                                                                                                echo 'unset';
                                                                                            }; ?>">
                                ...
                                <div class="mb-20 mt-5" style="display: <?php if (!$long_description) {
                                                                            echo 'none';
                                                                        } else {
                                                                            echo 'unset';
                                                                        }; ?>">
