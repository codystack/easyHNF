...
?>
<div class="d-flex flex-column flex-lg-row h-lg-100 gap-1" style=" display: <?php if (!$subscription_plan) {
                                                                                echo 'none';
                                                                            } else {
                                                                                echo 'unset';
                                                                            } ?>">
    ...
    <div class="flex-lg-fill overflow-x-auto ps-lg-1 vstack vh-lg-100 position-relative">
        ...
        <div class="flex-fill overflow-y-lg-auto scrollbar bg-body rounded-top-4 rounded-top-start-lg-4 rounded-top-end-lg-0 border-top border-lg shadow-2">
            <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                ...
                <div class="row g-3 g-xxl-6 mt-6" style="display: <?php if ($subscription_plan == 'Basic Plan') {
                                                                        echo 'unset';
                                                                    } elseif ($subscription_plan == 'Customized Plan' || 'Nutrition Coaching Plan') {
                                                                        echo 'none';
                                                                    } else {
                                                                        echo 'none';
                                                                    } ?>">
                                    ...
                                    <div class="table-responsive mb-10 mt-5">
                                        <table id="subscription" class="table table-hover table-striped table-sm table-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $mp_id = 1;
                                                // $select_query = "SELECT * FROM basic_meal_plan CROSS JOIN userdiet WHERE basic_meal_plan.diet = userdiet.diet AND userdiet.userID = '".$_SESSION['user_id']."' ";
                                                $select_query = "SELECT * FROM basic_meal_plan CROSS JOIN userdiet WHERE basic_meal_plan.diet = userdiet.diet AND userdiet.userID = '" . $_SESSION['user_id'] . "' ORDER BY basic_meal_plan.created_at DESC";
