            ...
            <main class="container-fluid px-3 py-5 p-lg-6 p-xxl-8">
                <div class="mb-6 mb-xl-10">
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col" style="display: <?php if ($subscription_plan == 'Basic Plan') {
                                                                echo 'unset';
                                    ...
                                    <div class="card bg-danger bg-opacity-10 border-danger border-opacity-40">
                                        <div class="card-body py-4">
                                            ...
                                            <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                ...
                                                <div class="mb-3">
                                                    <div style="<?php if ($subscription_plan == "") {
                                                                    echo 'display: unset';
                                                    ...
                                                    <div>
                                                        <button class="btn btn-sm btn-danger" type="button" disabled style="<?php if ($subscription_plan == "Basic Plan") {
                                                                                                                                echo 'display: unset';
                                                                                                                            } else {
                                                                                                                                echo 'display: none';
                                                                                                                            } ?>">Subscribed</button>
