...
function sendPasswordResetEmail($userEmail, $token)
{
  ...
  <table class=\'email-wraper\'>
                 ...
                 <td class=\'pdt-4x pdb-4x\'>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="" align="center" valign="top" style="padding:30px 40px">
                                                    <a href="https://easyhnf.com" style="text-decoration:none" target="_blank">
                                                    <img src="https://i.imgur.com/FXWZ4sR.png" width="200" height="" alt="" style="max-width:100%;height:auto;border:0;line-height:100%;outline:0;color:#1b1b1b" class="CToWUd"></a>
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <table class=\'email-body\' border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                        <div style=\'padding-left: 30px;\'>
                            <tbody>
                                <tr>
                                    <td class=\'pd-3x pdb-1-5x\'><h2 class=\'email-heading\' style="font-family:\'Helvetica\',Helvetica,Arial,sans-serif;color:#151515;font-size:18px;font-weight:700;line-height:34px;letter-spacing:-0.4px;text-align:center">Password Reset</h2></td>
                                </tr>
                                <tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="" style="padding:21px 20px 14px 20px;background-color:#12122c" valign="top" bgcolor="#12122c" role="presentation">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                        <tbody>
                                            <tr>
                                                <td style="font-size:0" valign="top">
                                                    
                                                    <div class="" style="display:inline-block;width:100%;max-width:280px;vertical-align:top">
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tbody>
                                                                <tr>
                                                                    <td style="padding:20px" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:18px;font-weight:500;line-height:24px;letter-spacing:-0.2px;color:#ffffff" valign="top">About Us.</td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;color:#d8d8d8" valign="top">At EasyHNF® we envision a world where everyone has access to personalized nutrition guidance and support to live happier and healthier lives.</td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:Arial,sans-serif;font-size:19px" valign="top">
                                                                                        <a href="https://web.facebook.com/easyHNF" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/jkoKheR.png" width="20" height="20" alt="Facebook" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                        <span>&nbsp;&nbsp;</span>
                                                                                        <a href="https://twitter.com/easyhnf" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/EJxrZD7.png" width="21" height="18" alt="Twitter" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                        <span>&nbsp;&nbsp;</span>
                                                                                        <a href="https://www.instagram.com/easyhnf" style="text-decoration:none" target="_blank"><img src="https://i.imgur.com/acSqHG4.png" width="21" height="20" alt="Instagram" style="border:0;line-height:100%;outline:0;color:#ffffff"></a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td style="padding:20px" valign="top">
                                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:14px;line-height:20px;letter-spacing:-0.2px;color:#d8d8d8" valign="top">Our support team is always available to help you with anything you might need, and to answer all your questions:</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="" height="45" style="line-height:1px;font-size:1px">&nbsp;</td>
                                                                                </tr>
                                                                            </tbody>
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:18px;font-weight:500;line-height:24px;letter-spacing:-0.2px" valign="top">
                                                                                        <a href="tel:+2349121879734" style="text-decoration:none;color:#d6e263;font-size:14px" target="_blank">+234 912 187 9734</a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="font-family:\'Helvetica\',sans-serif;font-size:14px;font-weight:500;line-height:24px" valign="top">
                                                                                        <a href="mailto:info@easyhnf.com" style="text-decoration:none;color:#d6e263" target="_blank">Send us an email</a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                      ...
                      <tbody>
                        <tr>
                            <td class="" style="padding:40px 30px 32px;background-color:#d6e263" valign="top" bgcolor="#d6e263">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                    <tbody>
                                        <tr>
                                            <td style="font-family:\'Helvetica\',Helvetica,Arial,sans-serif;font-size:14px;font-weight:400;line-height:28px;color:#9b9b9b;text-align:center" valign="top"><span style="color:#12122c"><strong>© 2024 EasyHNF® All rights reserved.</strong></td>
                                        </tr>
                                        <tr>
    ...
    $message = (new Swift_Message('Password Reset🔐'))
        ->setFrom(['noreply@easyhnf.com' => 'EasyHNF®'])
        ->setTo($userEmail)
