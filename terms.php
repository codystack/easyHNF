        ...
        <div class="section section-padding">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-9">
                        <p>The terms and conditions ("Terms and Conditions") in this document constitute the agreement ("Agreement") outlining the legal framework governing the relationship between Easy Health, Nutrition & Fitness ("EasyHNF") and you, the user of the services ("You" or "User").</p>
                        <p>By accessing or using the services provided by EasyHNF ("Services"), you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree with any part of these Terms and Conditions, you must not access or use the Services.</p>

                        <h1 style="margin-top: 20px; margin-bottom: 10px;">Service Terms and Conditions</h1>
                        <p>
                        ...
                        <p>These Terms and Conditions shall be governed by and construed in accordance with the laws of the Republic of Nigeria.</p>
                    </div>
                </div>
            </div>
        </div>
